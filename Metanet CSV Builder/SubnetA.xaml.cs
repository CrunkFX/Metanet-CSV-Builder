...
namespace Metanet_CSV_Builder
{
    ...
    /// </summary>
    public partial class SubnetA : MetroWindow
    {
        private readonly string CSVPath = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "/Hussmann/MetanetCSV/DB/SubnetA/CSV/";
        private readonly string CSVTemp = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "/Hussmann/MetanetCSV/Temp/SubnetA/CSV/";
        private readonly string ConfigFolder = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "/Hussmann/MetanetCSV/Temp/SubnetA/";
        private readonly string SysDB = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "/Hussmann/MetanetCSV/DB/SubnetA/DB.mcb";
        ...
        public SubnetA()
        {
            ...
            App.Current.Properties["DevMGR"] = "SubnetA";
