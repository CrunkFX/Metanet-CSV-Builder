...
namespace Metanet_CSV_Builder
{
    ...
    /// </summary>
    public partial class SubnetC : MetroWindow
    {
        private readonly string CSVPath = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "/Hussmann/MetanetCSV/DB/SubnetC/CSV/";
        private readonly string CSVTemp = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "/Hussmann/MetanetCSV/Temp/SubnetC/CSV/";
        private readonly string ConfigFolder = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "/Hussmann/MetanetCSV/Temp/SubnetC/";
        private readonly string SysDB = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "/Hussmann/MetanetCSV/DB/SubnetC/DB.mcb";
        ...
        {
            InitializeComponent();
            App.Current.Properties["DevMGR"] = "SubnetC";
